...
$(PARSER_TEST_TARGET): $(PARSER_TAB_CPP) $(LEXER_GEN_FOR_PARSER) src/symbol_table/symbol_table.cpp src/semantic/semantic_analyzer.cpp src/codegen/tac_generator.cpp
	@mkdir -p $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) -I$(BUILD_DIR) -o $@ $(PARSER_TAB_CPP) $(LEXER_GEN_FOR_PARSER) src/symbol_table/symbol_table.cpp src/semantic/semantic_analyzer.cpp src/codegen/tac_generator.cpp
clean:
	rm -rf $(BUILD_DIR)